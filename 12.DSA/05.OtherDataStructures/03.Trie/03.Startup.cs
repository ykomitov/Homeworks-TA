    ...
    public class Startup
    {
        public static void Main()
        {
            ...
            */
            ...
            var path = "../../1000words.txt"; // On my machine this code processes 128 mb text file in ~ 13 seconds
            DataReader new_reader = new DataReader(path, ref root);

            new_reader.ThreadRun();

            int distinct_word_count = 0;
            int total_word_count = 0;
            root.GetTopCounts(root, ref distinct_word_count, ref total_word_count);
            ...
            Console.WriteLine("Number of distinct words in the set: {0}", distinct_word_count);
