namespace SourceControlSystem.Services.Data.Tests
{
    ...
    public class ProjectsServiceTests
    {
        ...
        {
            var result = this.projectsService.Add("Test", "Test", "Invalid User", 1);
        }

        [TestMethod]
        public void AddShouldInvokeSaveChanges()
        {
            var result = this.projectsService.Add("Test", "Test", "Test User 1", 1);
        ...
        {
            var result = this.projectsService.Add("Test", "Test Description", "Test User 1", 1);
