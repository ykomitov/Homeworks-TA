namespace TeleimotBg.Web.Api.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        private ApplicationUserManager userMaganer;
        ...
        public ApplicationUserManager UserManager
        {
            get
            {
                return this.userMaganer ?? Request.GetOwinContext().GetUserManager<ApplicationUserManager>();
            }

            private set
            {
                this.userMaganer = value;
            }
        }
        ...
        {
            if (disposing && this.userMaganer != null)
            {
                this.userMaganer.Dispose();
                this.userMaganer = null;
            }
