<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="YouTubePlaylists.Account.Register" %>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                ...
                <asp:RequiredFieldValidator runat="server" ControlToValidate="FirstName"
                    CssClass="text-danger" ErrorMessage="You have to fill your first name!" />
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-10">
                ...
                <asp:RequiredFieldValidator runat="server" ControlToValidate="LastName"
                    CssClass="text-danger" ErrorMessage="You have to fill your last name!" />
            </div>
        </div>
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="AvatarUrl" CssClass="col-md-2 control-label">Avatar URL</asp:Label>
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="AvatarUrl" CssClass="form-control" />
            </div>
        </div>
        <div class="form-group">
